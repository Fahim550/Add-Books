...
export default function Navbar() {
  return (
    <header className="p-4 sticky top-0 z-50 dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex justify-between h-16 mx-auto">
		...
		<ul className="items-stretch hidden space-x-3 lg:flex">
			...
			<li className="flex">
				<Link to={'/viewbook'} className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Show Book</Link>
			</li>
			<li className="flex">
				<Link to='/addbook' className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Add Book</Link>
			</li>
